    ...
    <section className='portifolio' ref={portifolioRef}>
      <VerticalTimeline>
        <VerticalTimelineElement
          ...
          icon={
            <Image src={education} alt='Education Icon' width={48} height={48} />
          }
        >
        ...
        <VerticalTimelineElement
          ...
          iconStyle={{ background: '#fff', color: '#fff' }}
          icon={
            <Image src={work} alt='Working Icon' width={48} height={48} />
          }
        >
        ...
        <VerticalTimelineElement
          ...
          iconStyle={{ background: '#fff', color: '#fff' }}
          icon={
            <Image src={certificate} alt='Certificate Icon' width={48} height={48} style={{ margin: '10%' }} />
          }
        >
        ...
        <VerticalTimelineElement
          ...
          iconStyle={{ background: '#fff', color: '#fff' }}
          icon={
            <Image src={certificate} alt='Certificate Icon' width={48} height={48} />
          }
        >
        ...
        <VerticalTimelineElement
          ...
          icon={
            <Image src={code} alt='Code Icon' width={48} height={48} />
          }
        />
      </VerticalTimeline>
    </section>
